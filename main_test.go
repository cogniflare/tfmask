...
var lineTests = []struct {
	...
	{"random_id.some_id",
		...
		"0.11"},
	{"random_id.some_id",
		" stage.0.action.0.configuration.OAuthToken: <tf.0.11> => <tf.0.11> ",
	...
	{"random_id.some_id",
		...
		"0.11"},
	{"random_id.some_id",
		" stage.0.action.0.configuration.ObfuscateBecauseId: <tf.0.11> => <tf.0.11> ",
		" stage.0.action.0.configuration.ObfuscateBecauseId: <*******> => <*******> ",
		"0.11"},
	{"random_id.some_id",
	...
	{"random_id.some_id",
		...
		"0.12"},
	{"random_id.some_id",
		"      ~ result           = \"pkwemfpwmfwf\" -> (known after apply) ",
	...
	{"random_string.some_password",
		...
		"0.12"},
	{"random_id.some_id",
		" ~ id =               \"VIxvs2TloohI2XtAsHyu68wQvFQQCTOGgsglqC7zKjsnOmUMIMrZ1y5J6ieOIzl-YXiS1_XmVc8J8gb9fIcwIA\" -> (known after apply)",
		" ~ id =               \"**************************************************************************************\" -> (known after apply)",
		"0.12"},
	{"",
		"        ~ password    = \"sosecret\" -> \"sosecreta\"  ",
		"        ~ password    = \"********\" -> \"*********\"  ",
		"0.12"},
	{"",
		"        ~ dontObfuscate    = \"notsosecret\" -> \"notsosecreta\"  ",
		"        ~ dontObfuscate    = \"notsosecret\" -> \"notsosecreta\"  ",
		"0.12"},
	{"",
		"          password    = \"sosecret\"  ",
